...
import pizzaGenericStyles from './PizzaIngredient.module.css';
        ...
        <div className={pizzaGenericStyles.plate}>
            <div className={pizzaGenericStyles.pizzaBase1}>
                <div className={pizzaGenericStyles.pizzaBase2}>
                    ...
                    <div className={oliveStyles.olive11}></div>
                    <div className={oliveStyles.olive12}></div>
                    <div className={oliveStyles.olive13}></div>
                    <div className={oliveStyles.olive14}></div>
                    <div className={oliveStyles.olive15}></div>
                    <div className={oliveStyles.olive16}></div>
                    <div className={oliveStyles.olive17}></div>
                    <div className={oliveStyles.olive18}></div>
                    <div className={oliveStyles.olive19}></div>
                    <div className={oliveStyles.olive20}></div>
                </div>
            </div>
